...
List MKFIS(List& MLES, mat& Y, mat& X, mat& Z, double& init, List& hypers){
  ...
  double xL,timeL,thetaL,numCov,numS,lagL0,lagL1,minlag,maxlag,ref0_in_switch;
  ...
  //// Theta.t.t_1.all stores from t=1 to T:   theta_{1|0}^{.,.}        ~ theta_{T|T-1}^{.,.}
  ...
  //// PrI.t_1t.t_1.all store from t=1 to T:   Pr(I_0, I_1 | psi_{0})   ~ Pr(I_{T-1}, I_{T} | psi_{T-1})
